...
<a href="https://www.star-history.com/?repos=AgaMiko%2Fdata-augmentation-review&type=date&legend=top-left">
 <picture>
   <source media="(prefers-color-scheme: dark)" srcset="https://api.star-history.com/image?repos=AgaMiko/data-augmentation-review&type=date&theme=dark&legend=bottom-right" />
   <source media="(prefers-color-scheme: light)" srcset="https://api.star-history.com/image?repos=AgaMiko/data-augmentation-review&type=date&legend=bottom-right" />
...
========================================================================================================================================================================================
📘 Updated Private Credit Research Repository — Including 2026 Publications
Organised by research methodology, with the latest 2026 insights included.

1️⃣ MACRO-FINANCIAL RESEARCH (Systemic & Market Structure)
...
Key Insights:
Private credit AUM grew from ~$158B in 2010 to ~$2T by mid-2024
Lender technology differs meaningfully from bank lending
Investors earn spread premia, but high fees can consume returns
...
Findings:
2025 global commitments reached $224.25B, up 3.2% vs 2024
Direct lending was the predominant strategy
Europe saw record private credit fund closes
...
(Quantitative market data and performance studies)
...
Comparative capital structure study
Descriptive statistical modelling
Borrower substitution analysis
Core Findings:
Expansion driven by institutional demand for yield
Substitution away from syndicated loan markets
Increasing role in mid-market financing
Contribution:
...
Core Findings:
Significant SME reliance on private debt
Regional disparities in capital allocation
Concentration among direct lenders
Contribution:
...
Captures systemic drivers
Limited granular data
Empirical market analysis
Provides micro evidence
...
Show where your contribution fits
For example:
If your research is macro-empirical → extend BIS findings with new data.
If structural → quantify covenant dynamics.
If risk-focused → model tightening-cycle stress.
Now the important question:
What is your intended methodological position?
Are you:
Macro-econometric?
Empirical micro-level?
